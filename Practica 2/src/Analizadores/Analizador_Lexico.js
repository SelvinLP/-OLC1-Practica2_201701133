...
var L_Tokens;
var L_Tokens_Error;
var Analizador_L = /** @class */ (function () {
    function Analizador_L() {
    ...
    Analizador_L.prototype.Analizar_Cadena = function (Contenido) {
        var Fila = 1;
        var Columna = 1;
        var Estado = 0;
        var Cadena = "";
